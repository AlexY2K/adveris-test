...
export async function Articles() {
  ...
  const articles = posts.slice(0, 3).map((post, index) => ({
    id: post.id,
    title: post.title,
  ...
  return (
    <section className="bg-[#1a1a2e] py-30">
      <div className="container mx-auto px-4">
        <h2 className="text-center mb-8 font-darker-grotesque text-white text-[88px] font-medium leading-[.75] max-w-[600px] mx-auto">
          Lorem ipsum dolor donec sed odio.
        </h2>
        <p className="text-center mb-18 font-open-sans text-white text-normal font-light leading-[1.5] max-w-[600px] mx-auto">
          Donec sed odio dui. Fusce dapibus, tellus ac cursus commodo, tortor
          mauris condimentum nibh, ut fermentum massa justo sit amet risus.
        </p>
        <div className="articles-grid grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-[13vw]">
